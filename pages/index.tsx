    ...
    <div className="relative min-h-screen overflow-hidden bg-zinc-950 text-zinc-50 font-sans selection:bg-zinc-50 selection:text-zinc-950">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        <main className="mt-20 text-center sm:mt-28">
          <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-zinc-200 dark:border-zinc-800 bg-zinc-900/50 px-4 py-1.5 text-xs text-zinc-600 dark:text-zinc-400 ">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 text-left">
            ...
            <Link
              href="/auth/login"
              className="group relative rounded-2xl border border-zinc-900 bg-zinc-900/30 p-6 transition-all hover:border-zinc-200 dark:border-zinc-800 hover:bg-zinc-900/50 hover:shadow-lg hover:shadow-zinc-950/20 "
            >
              ...
              <div className="mt-4 inline-flex items-center gap-1 text-xs font-semibold text-zinc-600 dark:text-zinc-400 group-hover:text-yellow-500 transition-colors">
            ...
            <Link
              href="/dashboard"
              className="group relative rounded-2xl border border-zinc-900 bg-zinc-900/30 p-6 transition-all hover:border-zinc-200 dark:border-zinc-800 hover:bg-zinc-900/50 hover:shadow-lg hover:shadow-zinc-950/20  sm:col-span-2 lg:col-span-1"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-zinc-800 text-zinc-50 group-hover:bg-zinc-50 group-hover:text-zinc-950 transition-all">
                <Layout className="h-6 w-6" />
              </div>
